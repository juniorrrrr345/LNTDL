...
export default function ContactPage({ content: initialContent, socialLinks }: ContactPageProps) {
  const [content, setContent] = useState(initialContent);
  useEffect(() => {
    // Charger depuis le cache si disponible
    const cachedPage = contentCache.getPage('contact');
    ...
    const handleCacheUpdate = () => {
      const updatedPage = contentCache.getPage('contact');
